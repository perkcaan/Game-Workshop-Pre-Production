...
public class SpotTargetNode : BehaviourTreeNode
{
    ...
    public override BTNodeState Evaluate()
    {
        ...
        //TODO: Put this on a cooldown so it doesnt do it constantly.
        // Set last seen target position and target in blackboard
    ...
    {
        if (!Blackboard.TryGet("rotation", out float rotation)) { }
